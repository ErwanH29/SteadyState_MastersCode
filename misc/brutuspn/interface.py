...
class BrutusInterface(CodeInterface, GravitationalDynamicsInterface, LiteratureReferencesMixIn, 
    ...
    def set_PN_terms():
        function = LegacyFunctionSpecification()
        function.can_handle_array = True
        function.addParameter('PN1p', dtype='int32', direction=function.IN)
        function.addParameter('PN1c', dtype='int32', direction=function.IN)
        function.addParameter('PN2', dtype='int32', direction=function.IN)
        function.addParameter('PN2_5', dtype='int32', direction=function.IN)
        function.result_type = 'int32'
        return function
    ...
    ####
    @legacy_function
    def get_lightspeed_string():
        function = LegacyFunctionSpecification()
        function.addParameter('zzeta', dtype='string', direction=function.OUT)
        function.result_type = 'int32'
        return function
    @legacy_function
    def set_lightspeed_string():
        function = LegacyFunctionSpecification()
        function.addParameter('zzeta', dtype='string', direction=function.IN)
        function.result_type = 'int32'
        return function
    @legacy_function
    def get_lightspeed():
        function = LegacyFunctionSpecification()
        function.addParameter('zzeta', dtype='float64', direction=function.OUT)
        function.result_type = 'int32'
        return function
    @legacy_function
    def set_lightspeed():
        function = LegacyFunctionSpecification()
        function.addParameter('zzeta', dtype='float64', direction=function.IN)
        function.result_type = 'int32'
        return function
    @legacy_function
    def get_lightspeed_flag():
        function = LegacyFunctionSpecification()
        function.addParameter('lightspeed_flag', dtype='bool', direction=function.OUT)
        function.result_type = 'int32'
        return function
...
class Brutus(GravitationalDynamics):
    ...
    def initialize_code(self):
        ...
        if not self.convert_nbody is None:
            value=self.convert_nbody.to_nbody(constants.c)
            self.parameters.zzeta = value
